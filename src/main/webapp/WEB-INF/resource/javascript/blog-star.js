document.addEventListener("DOMContentLoaded", function (event) {
    ...
    tinymce.init({
        ...
        "convert_urls": true,
        "height": 300,
        "images_upload_url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/tinymce-upload",
        "image_advtab": true,
...
app.controller("blogStar", ["$scope", "$window", "$log", "blogStar", function ($scope, $window, $log, blogStar) {
    ...
    $scope.checkFileSource = function () {
        ...
        if ($scope.fileName.value != "" || $scope.fileUrl.value != "") {
            ...
            if ($scope.fileSource.selected.name == "Source") {
                ...
                $scope.fileSource.response.value = "Please select blog star file source";
    ...
    $scope.checkStatus = function () {
        ...
        if ($scope.status.selected.name == "Status") {
            ...
            $scope.status.response.value = "Please select blog star status";
    ...
    $scope.delete = function (id, event) {
        ...
        var rest = {
            ...
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/delete"
        };
        blogStar.rest(rest, function (response) {
    ...
    $scope.edit = function (event) {
        ...
        if (valid) {
            ...
            var rest = {
                ...
                "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/update"
            };
            blogStar.rest(rest, function (response) {
    ...
    $scope.filterPagination = function (event) {
        ...
        var rest = {
            "data": data,
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/filter-pagination"
        };
        blogStar.rest(rest, function (response) {

            if (response.result) {

                $window.location.href = document.getElementById("config").getAttribute("data-base-url") + "/blog/star/";
    ...
    $scope.forceUpload = function () {
        ...
        document.getElementsByClassName("blog-star-file")[0].click();
    ...
    $scope.forceUploadThumbnail = function () {
        ...
        document.getElementsByClassName("blog-star-thumbnail")[0].click();
    ...
    $scope.goToPage = function (event) {
        ...
        if (event.which == 13) {
            ...
            $window.location.href = document.getElementById("config").getAttribute("data-base-url") + "/blog/star/page-" + $scope.site.page + "/";
    ...
    $scope.initializeData = function (id) {
        ...
        var rest = {
            ...
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/initialize-data"
        }
        blogStar.rest(rest, function (response) {
    ...
    $scope.initializePagination = function () {
        ...
        var rest = {
            "data": {},
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/initialize-pagination"
        };
        blogStar.rest(rest, function (response) {
    ...
    $scope.insert = function (event) {
        ...
        if (valid) {
            ...
            var rest = {
                ...
                "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/insert"
            };
            blogStar.rest(rest, function (response) {
            ...
            if (response.result) {
                ...
                if (response.hasOwnProperty("data")) {
                    ...
                    if (response.data.fileName != "") {
                        ...
                        $scope.fileName.upload.file = response.data.file.name;
                        $scope.fileName.upload.result = true;
                        $scope.fileName.value = document.getElementById("config").getAttribute("data-base-url") + "/resource/image/blog/star/" + response.data.file.name;
                    ...
                    if (response.data.thumbnail != "") {
                        ...
                        $scope.thumbnail.upload.file = response.data.thumbnail;
                        $scope.thumbnail.upload.result = true;
                        $scope.thumbnail.value = document.getElementById("config").getAttribute("data-base-url") + "/resource/image/blog/star/thumbnail/" + response.data.thumbnail;
    ...
    $scope.removeFilterPagination = function (event) {
        ...
        var rest = {
            "data": {},
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/remove-filter-pagination"
        };
        blogStar.rest(rest, function (response) {
    ...
    $scope.setPagination = function (event) {
        ...
        var rest = {
            ...
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/set-pagination"
        };
        blogStar.rest(rest, function (response) {
    ...
    $scope.uploadFile = function () {
        ...
        var rest = {
            "data": formData,
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/upload-file"
        };
        blogStar.restMultipart(rest, function (response) {
    ...
    $scope.uploadThumbnail = function () {
        ...
        var rest = {
            "data": formData,
            "url": document.getElementById("config").getAttribute("data-base-url") + "/blog/star/upload-thumbnail"
        };
        blogStar.restMultipart(rest, function (response) {
...
app.provider("blogStar", function () {
    ...
    this.$get = ["$http", function ($http) {
        ...
        blogStar.rest = function (rest, callback) {
        ...
        blogStar.restMultipart = function (rest, callback) {
...
app.directive("blogStarDetail", function () {
    ...
    blogStar.templateUrl = document.getElementById("config").getAttribute("data-base-url") + "/resource/html/blog-star-detail-popup.html";
...
app.directive("blogStarFilePreview", function () {


    var blogStar = {};


    blogStar.template = "<img class=\"responsive\" ng-src=\"" + document.getElementById("config").getAttribute("data-image-url") + "/blog/star/{{fileName.upload.file}}\" />";
...
app.directive("blogStarThumbnailPreview", function () {


    var blogStar = {};


    blogStar.template = "<img class=\"responsive\" ng-src=\"" + document.getElementById("config").getAttribute("data-image-url") + "/blog/star/thumbnail/{{thumbnail.upload.file}}\" />";
