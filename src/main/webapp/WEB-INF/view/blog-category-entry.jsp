...
<div id="content" ng-controller="blogCategory">
    ...
    <div class="wrapper">
        <div class="navigation">
            <div class="breadcrumb">
                ...
                <p><a href="${url.base}/blog/category/">Category</a><i class="next-white square-10 margin-left-5"></i>
                </p>
                <p>Entry</p>
        ...
        <form method="POST" action="" ng-init="initializeData('${entry._id}')">
            <div class="accordion">
                ...
                <div class="accordion-content data-entry" data-index="1">
                    ...
                    <div class="data">
                        <input name="blog-category-name" type="text" placeholder="Name" ng-keyup="checkName()"
                               ng-model="name.value"/>
                    </div>
                    <div class="response">
                    ...
                    <div class="title">
                        <p><span class="required">* </span>Parent</p>
                    </div>
                    <div class="data">
                        <md-input-container>
                            <md-select ng-change="checkParent()" ng-model="parent.selected" placeholder="Parent">
                                <md-option ng-repeat="option in parent.option" ng-value="option">
                    ...
                    <div class="response">
                        <p ng-show="parent.response.view" ng-class="parent.response.class">{{parent.response.value}}</p>
                    </div>
                    <div class="title file">
                        <p><span class="required"></span>Thumbnail</p>
                    </div>
                    <div class="data">
                        <input class="blog-category-thumbnail" name="blog-category-thumbnail" type="file"
                               thumbnail-input="files"/>
                        <div class="thumbnail-list" ng-show="thumbnail.upload.result">
                            <blog-category-thumbnail-preview></blog-category-thumbnail-preview>
                        </div>
                    ...
                    <div class="data">
                        <textarea id="tinymce-1" name="blog-category-content"
                    ...
                    <div class="data">
                        <textarea id="tinymce-2" name="blog-category-description"
                    ...
                    <div class="data">
                        <input name="blog-category-url" type="text" placeholder="URL" ng-keyup="checkUrl()"
                               ng-model="url.value"/>
                    </div>
                    <div class="response">
                    ...
                    <div class="data">
                        <input name="blog-category-meta-title" type="text" placeholder="Meta Title"
                    ...
                    <div class="data">
                        <textarea name="blog-category-meta-description" placeholder="Meta Description"
                    ...
                    <div class="data">
                        <input name="blog-category-meta-keyword" type="text" placeholder="Meta Keyword"
                    ...
                    <div class="data">
                        <input name="blog-category-og-title" type="text" placeholder="OG Title"
                               ng-keyup="checkOgTitle()" ng-model="ogTitle.value"/>
                    </div>
                    <div class="response">
                    ...
                    <div class="data">
                        <textarea name="blog-category-og-description" placeholder="OG Description"
                    ...
                    <div class="data">
                        <input name="blog-category-rate-amount" type="text" placeholder="Rate Amount"
                    ...
                    <div class="data">
                        <input name="blog-category-rate-contributor" type="text" placeholder="Rate Contributor"
                    ...
                    <div class="data">
                        <input name="blog-category-sequence" type="text" placeholder="Sequence"
                    ...
                    <div class="data" ng-show="createdDate.view">
                        <input name="blog-category-created-date" type="text" placeholder="Created Date" readonly
                    ...
                    <div class="data" ng-show="modifiedDate.view">
                        <input name="blog-category-modified-date" type="text" placeholder="Modified Date" readonly
                ...
                <div class="accordion-content data-entry" data-index="2">
                    ...
                    <div class="data">
                        <input class="blog-file" name="blog-category-file" type="file" file-input="files"/>
                    ...
                    <div class="data">
                        <input name="blog-category-url" type="text" placeholder="URL" ng-keyup="checkFileUrl()"
            ...
            <div class="button">
                <c:choose>
                    <c:when test="${!empty entry._id}">
                        <button class="edit" name="blog-category-edit" ng-click="edit($event)"><i
                                class="pencil-white square-15 margin-right-5"></i>Edit
                        </button>
                    </c:when>
                    <c:otherwise>
                        <button class="add" name="blog-category-insert" ng-click="insert($event)"><i
