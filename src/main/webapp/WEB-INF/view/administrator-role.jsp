...
<div id="content" ng-controller="administratorRole">
    <div id="popup" ng-show="popup.view">
        <div class="wrapper" ng-show="popup.view">
            ...
            <div class="popup" ng-scrollbar rebuild-on-resize rebuild-on="rebuild:scrollbar">
                <administrator-role-detail ng-if="popup.administratorRole"></administrator-role-detail>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper" ng-init="initializePagination()">
        <div class="navigation">
            ...
            <div class="action">
                <a class="add" href="${url.base}/administrator/role/entry/"><i
                        class="plus-white square-15 margin-right-5"></i>Add New</a>
            </div>
        </div>
        <div class="filter">
            <form class="filter" method="POST" action="">
                <input class="id" name="administrator-role-filter-id" type="text" placeholder="ID"
                       ng-model="filter.id.value"/>
                <input name="administrator-role-filter-name" type="text" placeholder="Name"
                ...
                <input class="date-range-picker" name="administrator-role-filter-created-timestamp" type="text"
                       placeholder="Created Date Range" ng-model="filter.createdDate.value"/>
                <button class="filter" name="administrator-role-filter" ng-click="filterPagination($event)"><i
                        class="filter-white square-15 margin-right-5"></i>Filter
                </button>
                <button class="remove-filter" name="administrator-role-remove-filter"
        ...
        <div class="content">
            <form class="page-entry" method="POST" action="">
                <p>Page Entry</p>
                <input name="administrator-role-page-entry" type="text" placeholder="Page" ng-model="site.pagination"/>
                <button name="administrator-role-page" ng-click="setPagination($event)"><i
            ...
            <table class="data-list">
                ...
                <c:forEach items="${pagination}" var="pagination" varStatus="status">
                    <tr class="${pagination._id}" ng-dblclick="loadDetail('${pagination._id}')">
                        ...
                        <td class="action">
                            <div>
                                <a href="${url.base}/administrator/role/entry/${pagination._id}/"><i
