...
import com.preloode.panel.service.BlogStarService;
...
public class BlogStarController {
    ...
    public Setting setting() {
        ...
        return this.head.initialize("Blog Star");
    ...
    public String index(HttpServletRequest request, Map<String, Object> data) {
        ...
        if (this.preloodeAccount.get("result").equals(true)) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "blog_star", "view");

            if (privilegeCheck) {

                this.page = 1;

                data.put("link", this.blogStarService.createPaginationLink(request, this.preloodeAccount, this.page));
                data.put("menu", this.privilege.menu(this.preloodeAccount));
                data.put("page", this.page);
                data.put("pagination", this.blogStarService.loadPagination(request, this.preloodeAccount, this.page));
    ...
    public String add(Map<String, Object> data) {
        ...
        if (this.preloodeAccount.get("result").equals(true)) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "blog_star", "add");
    ...
    public String edit(@PathVariable("id") String id, Map<String, Object> data) {
        ...
        if (this.preloodeAccount.get("result").equals(true)) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "blog_star", "edit");

            if (privilegeCheck) {

                data.put("entry", this.blogStarService.loadEntry(id.replaceAll("[^A-Za-z0-9]", "")));
                data.put("menu", this.privilege.menu(this.preloodeAccount));
    ...
    public Map<String, Object> initializePagination(HttpServletRequest request) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.initializePagination(request, this.preloodeAccount, this.page);
    ...
    public Map<String, Object> filterPagination(HttpServletResponse response, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.filterPagination(response, this.preloodeAccount, data);
    ...
    public Map<String, Object> setPagination(HttpServletResponse response, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.setPagination(response, this.preloodeAccount, data);
    ...
    public Map<String, Object> removeFilterPagination(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.removeFilterPagination(request, response, this.preloodeAccount);
    ...
    public Map<String, Object> initializeData(@RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.initializeData(data);
    ...
    public Map<String, Object> uploadFile(HttpServletRequest request, MultipartHttpServletRequest multipartRequest) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.uploadFile(request, multipartRequest);
    ...
    public Map<String, Object> uploadThumbnail(HttpServletRequest request, MultipartHttpServletRequest multipartRequest) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.uploadThumbnail(request, multipartRequest);
    ...
    public Map<String, Object> tinymceUpload(HttpServletRequest request, MultipartHttpServletRequest multipartRequest) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.tinymceUploadFile(request, multipartRequest);
    ...
    public Map<String, Object> insert(HttpServletRequest request, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.insert(request, this.preloodeAccount, data);
    ...
    public Map<String, Object> update(HttpServletRequest request, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.blogStarService.update(request, this.preloodeAccount, data);
    ...
    public Map<String, Object> delete(HttpServletRequest request, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "blog_star", "delete");

            if (privilegeCheck) {

                result = this.blogStarService.delete(request, this.preloodeAccount, data);
