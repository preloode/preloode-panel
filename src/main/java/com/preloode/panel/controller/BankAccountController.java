...
import com.preloode.panel.service.BankAccountService;
...
public class BankAccountController {
    ...
    public Setting setting() {
        ...
        return this.head.initialize("Bank Account");
    ...
    public String index(HttpServletRequest request, Map<String, Object> data) {
        ...
        if (this.preloodeAccount.get("result").equals(true)) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "bank_account", "view");

            if (privilegeCheck) {

                this.page = 1;

                data.put("link", this.bankAccountService.createPaginationLink(request, this.preloodeAccount, this.page));
                data.put("menu", this.privilege.menu(this.preloodeAccount));
                data.put("page", this.page);
                data.put("pagination", this.bankAccountService.loadPagination(request, this.preloodeAccount, this.page));
    ...
    public String add(Map<String, Object> data) {
        ...
        if (this.preloodeAccount.get("result").equals(true)) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "bank_account", "add");
    ...
    public String edit(HttpServletRequest request, @PathVariable("id") String id, Map<String, Object> data) {
        ...
        if (this.preloodeAccount.get("result").equals(true)) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "bank_account", "edit");

            if (privilegeCheck) {

                data.put("entry", this.bankAccountService.loadEntry(id.replaceAll("[^A-Za-z0-9]", "")));
                data.put("menu", this.privilege.menu(this.preloodeAccount));
    ...
    public Map<String, Object> initializePagination(HttpServletRequest request) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.initializePagination(request, this.preloodeAccount, this.page);
    ...
    public Map<String, Object> filterPagination(HttpServletResponse response, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.filterPagination(response, this.preloodeAccount, data);
    ...
    public Map<String, Object> setPagination(HttpServletResponse response, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.setPagination(response, this.preloodeAccount, data);
    ...
    public Map<String, Object> removeFilterPagination(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.removeFilterPagination(request, response, this.preloodeAccount);
    ...
    public Map<String, Object> initializeData(@RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.initializeData(data);
    ...
    public Map<String, Object> uploadFile(HttpServletRequest request, MultipartHttpServletRequest multipartRequest) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.uploadFile(request, multipartRequest);
    ...
    public Map<String, Object> insert(HttpServletRequest request, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.insert(request, this.preloodeAccount, data);
    ...
    public Map<String, Object> update(HttpServletRequest request, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            if (privilegeCheck) {
                ...
                result = this.bankAccountService.update(request, this.preloodeAccount, data);
    ...
    public Map<String, Object> delete(HttpServletRequest request, @RequestBody Document data) {
        ...
        if (!this.preloodeAccount.isEmpty()) {
            ...
            Boolean privilegeCheck = this.privilege.check(this.preloodeAccount, "bank_account", "delete");

            if (privilegeCheck) {

                result = this.bankAccountService.delete(request, this.preloodeAccount, data);
